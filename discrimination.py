...
def Performance_eccentricity_plotter_P3(distance_array_wide,distance_array_medium,distance_array_narrow,ecc_pairs_wide,ecc_pairs_medium,ecc_pairs_narrow,performance_array_wide,performance_array_medium,performance_array_narrow,dist_value,trace_color_wide,trace_color_medium,trace_color_narrow,figure_title,file_name):
    """
    This function plots discrimination performance as a function of probes mean 
    eccentricity for specific probes separation. Then, it calculates linear 
    correlation p-value between performance and eccentricity.
