...
def Performance_eccentricity_onblind_plotter_P3(distance_array,ecc_pairs,performance_array,performance_array_blind,dist_value,trace_color,trace_color_blind,figure_title,file_name):
    """Performance-eccentricity
    Plots of performance-eccentricity comparing correlation-aware and 
    correlation-blind decoders
    """
