...
#location of the fixed point (fovea) is at the upper middle of the grid
...
#This function determines the center coordinations of the receptive fields centers
...
#This function calculates the eccentricity of the receptive field centers
...
#This function plots the diameter of the receptive fields versus their center eccentricity
...
#This function plots the eccentricity of each electrode on its location on the electrode array
...
def Performance_eccentricity_plotter(distance_array_wide,distance_array_medium,distance_array_narrow,ecc_pairs_wide,ecc_pairs_medium,ecc_pairs_narrow,performance_array_wide,performance_array_medium,performance_array_narrow,dist_value,trace_color_wide,trace_color_medium,trace_color_narrow,figure_title,file_name):
    ...
    y_x_medium,y_x_std_medium=mean_relationship(ecc_values_medium,performance_array_values_medium,np.arange(3,21,3))
    y_x_narrow,y_x_std_narrow=mean_relationship(ecc_values_narrow,performance_array_values_narrow,np.arange(3,21,3))
...
electrode_set=np.array([ 0,  3,  4,  5,  8, 10, 12, 14, 15, 18, 19, 21, 24, 26, 27, 29, 31,
       39, 41, 47, 48, 49, 50, 52, 58, 60, 64, 66, 68, 72, 73, 74, 90, 91])
...
RFDiameterEccentricityPlot(RF_center_eccentricity_MUA_wide,RF_mean_diameter_MUA_wide,'r','MUA Wide','RF_diameter_ecc_MUA_wide')
RFDiameterEccentricityPlot(RF_center_eccentricity_LFP_wide,RF_mean_diameter_LFP_wide,'b','LFP Wide','RF_diameter_ecc_LFP_wide')
...
RFDiameterEccentricityPlot(RF_center_eccentricity_MUA_medium,RF_mean_diameter_MUA_medium,'r','MUA Medium','RF_diameter_ecc_MUA_medium')
RFDiameterEccentricityPlot(RF_center_eccentricity_LFP_medium,RF_mean_diameter_LFP_medium,'b','LFP Medium','RF_diameter_ecc_LFP_medium')
...
RFDiameterEccentricityPlot(RF_center_eccentricity_MUA_narrow,RF_mean_diameter_MUA_narrow,'r','MUA Narrow','RF_diameter_ecc_MUA_narrow')
RFDiameterEccentricityPlot(RF_center_eccentricity_LFP_narrow,RF_mean_diameter_LFP_narrow,'b','LFP Narrow','RF_diameter_ecc_LFP_narrow')
...
MUA_clustering_selected_electrodes=np.array([39, 64, 50, 58, 10, 72, 47, 86])
...
LFP_clustering_selected_electrodes=np.array([84, 85, 38, 64, 48, 0, 10, 40, 58])
...
electrode=49
separation_dist=4
probes_weight(MUA_weight_set,electrode,MUA_responsive_electrodes_wide,MUA_probe_pairs_wide,separation_dist,MUA_distance_array_wide,'MUA_weight_field_elec49_separation4.png')
separation_dist=8
probes_weight(MUA_weight_set,electrode,MUA_responsive_electrodes_wide,MUA_probe_pairs_wide,separation_dist,MUA_distance_array_wide,'MUA_weight_field_elec49_separation8.png')
separation_dist=12
probes_weight(MUA_weight_set,electrode,MUA_responsive_electrodes_wide,MUA_probe_pairs_wide,separation_dist,MUA_distance_array_wide,'MUA_weight_field_elec49_separation12.png')

tuning_plotter(stim,MUA_dataset,electrode,-0.27,0.27,'MUA_tuning_curve_elec49.png')
...
electrode=10
separation_dist=4
probes_weight(LFP_weight_set,electrode,LFP_responsive_electrodes_medium,LFP_probe_pairs_medium,separation_dist,LFP_distance_array_medium,'LFP_weight_field_elec10_separation4.png')
separation_dist=8
probes_weight(LFP_weight_set,electrode,LFP_responsive_electrodes_medium,LFP_probe_pairs_medium,separation_dist,LFP_distance_array_medium,'LFP_weight_field_elec10_separation8.png')
separation_dist=12
probes_weight(LFP_weight_set,electrode,LFP_responsive_electrodes_medium,LFP_probe_pairs_medium,separation_dist,LFP_distance_array_medium,'LFP_weight_field_elec10_separation12.png')
...
electrode=16
separation_dist=4
probes_weight(LFP_weight_set,electrode,LFP_responsive_electrodes_medium,LFP_probe_pairs_medium,separation_dist,LFP_distance_array_medium,'LFP_weight_field_elec16_separation4.png')
separation_dist=8
probes_weight(LFP_weight_set,electrode,LFP_responsive_electrodes_medium,LFP_probe_pairs_medium,separation_dist,LFP_distance_array_medium,'LFP_weight_field_elec16_separation8.png')
separation_dist=12
probes_weight(LFP_weight_set,electrode,LFP_responsive_electrodes_medium,LFP_probe_pairs_medium,separation_dist,LFP_distance_array_medium,'LFP_weight_field_elec16_separation12.png')

tuning_plotter(stim,-LFP_dataset,electrode,-0.34,0.34,'LFP_tuning_curve_elec16.png')



electrode=39
separation_dist=4
probes_weight(LFP_weight_set,electrode,LFP_responsive_electrodes_medium,LFP_probe_pairs_medium,separation_dist,LFP_distance_array_medium,'LFP_weight_field_elec39_separation4.png')
separation_dist=8
probes_weight(LFP_weight_set,electrode,LFP_responsive_electrodes_medium,LFP_probe_pairs_medium,separation_dist,LFP_distance_array_medium,'LFP_weight_field_elec39_separation8.png')
separation_dist=12
probes_weight(LFP_weight_set,electrode,LFP_responsive_electrodes_medium,LFP_probe_pairs_medium,separation_dist,LFP_distance_array_medium,'LFP_weight_field_elec39_separation12.png')

tuning_plotter(stim,-LFP_dataset,electrode,-0.34,0.34,'LFP_tuning_curve_elec39.png')
...
MUA_p_values_weight_corticaldist=weight_corticaldist(MUA_weight_set,MUA_cortical_distances_wide,MUA_responsive_electrodes_wide,10)
LFP_p_values_weight_corticaldist=weight_corticaldist(LFP_weight_set,LFP_cortical_distances_medium,LFP_responsive_electrodes_medium,10)


MUA_p_values_importance_corticaldist=mean_importance_corticaldist(MUA_weight_set,MUA_cortical_distances_wide,MUA_responsive_electrodes_wide,10,58,49,18)
LFP_p_values_importance_corticaldist=mean_importance_corticaldist(LFP_weight_set,LFP_cortical_distances_medium,LFP_responsive_electrodes_medium,10,16,39,48)
...
remove_ind=np.array([],dtype=int)
for i in np.arange(len(MUA_probe_pairs_wide)):
    if (MUA_probe_pairs_wide[i,0]==25) | (MUA_probe_pairs_wide[i,1]==25) | (MUA_probe_pairs_wide[i,0]==72) | (MUA_probe_pairs_wide[i,1]==72):
        remove_ind=np.append(remove_ind,i)

MUA_probe_pairs_wide_r=np.delete(MUA_probe_pairs_wide,remove_ind,0)

MUA_cortical_distances_wide_r=np.delete(MUA_cortical_distances_wide,remove_ind,0)

MUA_performance_array_wide_r=np.delete(MUA_performance_array_wide,remove_ind,0)

MUA_distance_array_wide_r=np.delete(MUA_distance_array_wide,remove_ind,0)

MUA_ecc_pairs_wide_r=np.delete(MUA_ecc_pairs_wide,remove_ind,0)

MUA_performance_array_importance_six_selected_r=np.delete(MUA_performance_array_importance_six_selected,remove_ind,0)



remove_ind=np.array([],dtype=int)
for i in np.arange(len(LFP_probe_pairs_medium)):
    if (LFP_probe_pairs_medium[i,0]==25) | (LFP_probe_pairs_medium[i,1]==25) | (LFP_probe_pairs_medium[i,0]==72) | (LFP_probe_pairs_medium[i,1]==72):
        remove_ind=np.append(remove_ind,i)

LFP_probe_pairs_medium_r=np.delete(LFP_probe_pairs_medium,remove_ind,0)

LFP_cortical_distances_medium_r=np.delete(LFP_cortical_distances_medium,remove_ind,0)

LFP_performance_array_medium_r=np.delete(LFP_performance_array_medium,remove_ind,0)

LFP_distance_array_medium_r=np.delete(LFP_distance_array_medium,remove_ind,0)

LFP_ecc_pairs_medium_r=np.delete(LFP_ecc_pairs_medium,remove_ind,0)

LFP_performance_array_importance_six_selected_r=np.delete(LFP_performance_array_importance_six_selected,remove_ind,0)

#all the responsive electrodes

MUA_performance_array_blind=Discrimination_performance_array_onblind(MUA_probe_pairs_wide_r,stim,MUA_dataset[:,MUA_responsive_electrodes_wide])
LFP_performance_array_blind=Discrimination_performance_array_onblind(LFP_probe_pairs_medium_r,stim,LFP_dataset[:,LFP_responsive_electrodes_medium])

#six most important responsive electrodes

MUA_performance_array_importance_six_blind=Discrimination_performance_array_onblind(MUA_probe_pairs_wide_r,stim,MUA_dataset[:,MUA_weightsorted_electrodes[0:6]])
LFP_performance_array_importance_six_blind=Discrimination_performance_array_onblind(LFP_probe_pairs_medium_r,stim,LFP_dataset[:,LFP_weightsorted_electrodes[0:6]])

#Plot discrimination performance vs cortical distance

performance_corticaldistance_onblind_plotter(MUA_cortical_distances_wide_r,MUA_performance_array_wide_r,MUA_performance_array_blind,(0.435, 0.043, 0.043),(0.992, 0.576, 0.070),'MUA','MUA_performance_corticaldist_correlationblind.png')
performance_corticaldistance_onblind_plotter(LFP_cortical_distances_medium_r,LFP_performance_array_medium_r,LFP_performance_array_blind,(0.145, 0.188, 0.894),(0.964, 0.070, 0.992),'LFP','LFP_performance_corticaldist_correlationblind.png')

#Plot discrimination performance vs Eccentricity

separation_dist=4
Performance_eccentricity_onblind_plotter(MUA_distance_array_wide_r,MUA_ecc_pairs_wide_r,MUA_performance_array_wide_r,MUA_performance_array_blind,separation_dist,(0.435, 0.043, 0.043),(0.992, 0.576, 0.070),'MUA 4 deg separation','MUA_performance_eccentricity_correlationblind_fourdeg.png')

separation_dist=8
Performance_eccentricity_onblind_plotter(MUA_distance_array_wide_r,MUA_ecc_pairs_wide_r,MUA_performance_array_wide_r,MUA_performance_array_blind,separation_dist,(0.435, 0.043, 0.043),(0.992, 0.576, 0.070),'MUA 8 deg separation','MUA_performance_eccentricity_correlationblind_eightdeg.png')


separation_dist=4
Performance_eccentricity_onblind_plotter(LFP_distance_array_medium_r,LFP_ecc_pairs_medium_r,LFP_performance_array_medium_r,LFP_performance_array_blind,separation_dist,(0.145, 0.188, 0.894),(0.964, 0.070, 0.992),'LFP 4 deg separation','LFP_performance_eccentricity_correlationblind_fourdeg.png')

separation_dist=8
Performance_eccentricity_onblind_plotter(LFP_distance_array_medium_r,LFP_ecc_pairs_medium_r,LFP_performance_array_medium_r,LFP_performance_array_blind,separation_dist,(0.145, 0.188, 0.894),(0.964, 0.070, 0.992),'LFP 8 deg separation','LFP_performance_eccentricity_correlationblind_eightdeg.png')


#Plot discrimination performance vs cortical distance for six most important responsive electrodes

performance_corticaldistance_onblind_plotter(MUA_cortical_distances_wide_r,MUA_performance_array_importance_six_selected_r,MUA_performance_array_importance_six_blind,(0.435, 0.043, 0.043),(0.992, 0.576, 0.070),'MUA six best electrodes','MUA_performance_importance_six_corticaldist_correlationblind.png')
performance_corticaldistance_onblind_plotter(LFP_cortical_distances_medium_r,LFP_performance_array_importance_six_selected_r,LFP_performance_array_importance_six_blind,(0.145, 0.188, 0.894),(0.964, 0.070, 0.992),'LFP six best electrodes','LFP_performance_importance_six_corticaldist_correlationblind.png')
